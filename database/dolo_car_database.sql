-- The the account table --
CREATE TYPE public.account_type AS ENUM
    ('Client', 'Employee', 'Admin');

ALTER TYPE public.account_type
    OWNER TO dolomotorsdatabase;

-- Table structure for the 'classification' table --
...
-- The table structure for the 'Inventory' table -- 
...
-- create relationship between the 'classification' and 'inventory' table 
